...
namespace Mono.AssemblyLinker
{
	...
	public class AssemblyLinker {
		...
		private void DoIt () {
			...
			if (isTemplateFile)
				ReadCustomAttributesFromTemplateFile (templateFile, ref aname);
		...
		private void ReadCustomAttributesFromTemplateFile (string templateFile, ref AssemblyName aname)
		{
