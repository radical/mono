...
namespace DebuggerTests
{
	...
	public class CallFunctionOnTests : DebuggerTestBase {
		...
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:LocalsTest', 10);", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3, 10, false)]
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:LocalsTest', 0);", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3, 0, true)]
		...
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:LocalsTest', 10);", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3, 10)]
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:LocalsTest', 0);", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3, 0)]
		...
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:LocalsTest', 10);", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3, false)]
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:LocalsTest', 10);", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3, true)]
		...
		=>	await RunCallFunctionOn (
				...
				"function (m) { return Object.values (this).filter ((k, i) => i%m == 0); }",
				"ss_arr",
				"dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3,
				fn_args: JArray.FromObject (new [] { new { value = 2 } }),
				res_array_len: 5,
				roundtrip: roundtrip,
				test_fn: async (result) => {
		...
		=>	await RunCallFunctionOn (
				...
				bp_loc:     "dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3,
				roundtrip:  roundtrip,
				test_fn: async (result) => {
		...
		public async Task CheckErrorsWithSilent (bool? silent)
		{
			...
			await insp.Ready (async (cli, token) => {
				ctx = new DebugTestContext (cli, insp, token, scripts);
				await SetBreakpoint ("dotnet://debugger-test.dll/debugger-cfo-test.cs", 34, 3);
		...
		[Theory]
		[InlineData ("invoke_static_method_async ('[debugger-test] DebuggerTests.CallFunctionOnTest:PropertyGettersTestAsync');", "MoveNext", 17, 3)]
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:PropertyGettersTest');", "PropertyGettersTest", 9, 3)]
		...
		[Theory]
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:PropertyGettersTest');", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 9, 3, false)]
		[InlineData ("invoke_static_method ('[debugger-test] DebuggerTests.CallFunctionOnTest:PropertyGettersTest');", "dotnet://debugger-test.dll/debugger-cfo-test.cs", 9, 3, true)]
